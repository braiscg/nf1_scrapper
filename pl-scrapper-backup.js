...
const cheerio = require('cheerio');const url = 'https://twitter.com/FT';const recoveredTweets = [];axios(url)
    .then(response => {
        ...
        tweets.each(function() {
            ...
            const time2=$(this).find('.tweet-timestamp').attr('title');            recoveredTweets.push({
                user,
                body,
                time,
                time2
    ...
    .catch(console.error);function write (recoveredTweets) {    const MongoClient = require('mongodb').MongoClient;
